    ...
    return <> 
        <div className="relative text-black-mut overflow-x-auto bg-gray-light shadow-md sm:rounded-lg mt-12 p-12">
                        ...
                        <tr key={product.product.id} className="border-b flex flex-wrap sm:flex-nowrap">
                            ...
                            <td className='sm:w-1/2 md:w-4/6 xl:w-5/6 flex flex-col sm:flex-row flex-wrap sm:flex-c justify-between items-center grow'>
                                ...
                                <div className="flex items-center gap-4 text-base my-3 md:my-0">
                                    <button onClick={() => updateQuantity(product.product.id, product.count-1)} className="flexitems-center justify-center px-3 py-1.5 text-sm font-medium text-gray-400 border border-green-light rounded focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200" type="button">
            ...
            <div className="flex items-center justify-center my-3">
                <button onClick={clearCartFn} className='btn-outline-accent'>Clear Your Cart</button>
            </div>
        </div>
    </>
}
